...
from waymax import env as waymax_envax_env

from vmax.simulator.features import extractor
from vmax.simulator.wrappers import observation


class ObsRoadWrapper(observation.AbstractObservationWrapper):
    """Observation wrapper that returns a global vector observation."""

    def __init__(
        self,
        env: waymax_envax_env.PlanningAgentEnvironment,
        ...
        super().__init__(
            env,
            extractor.RoadFeaturesExtractor(
