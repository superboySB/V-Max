...
from vmax.learning.networks import encoders, fully_connected
...
class MLPEncoder(nn.Module):
    ...
    def __call__(self, obs: jax.Array) -> jax.Array:
        ...
        # Apply mlp
        output = fully_connected.MLP(layer_sizes=self.concat_layer_sizes, activation=self.concat_activation)(input)
