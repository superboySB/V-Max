...
class MGAILAttention(nn.Module):
    """MGAIL attention module.
    ...
    def __call__(self, xs, masks):
        """Compute the forward pass of the MGAIL attention module.
        ...
        # MGAIL - different weights for each cross and self attention
...
class MGAILEncoder(nn.Module):
    """MGAIL encoder module.

    Constructs embeddings for sub-features and applies MGAIL attention to encode observations.
    ...
    def __call__(self, obs: jax.Array) -> jax.Array:
        """Perform the forward pass of the MGAIL encoder.
